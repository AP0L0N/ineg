...
document.addEventListener('DOMContentLoaded', function () {
  swiper__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleControls = function () {
    var allSlidesVisible = this.slides.length <= (this.params.slidesPerView == 'auto' ? 1 : this.params.slidesPerView);
    var elementDisplay = allSlidesVisible ? 'none' : 'flex';
  ...
  var navSwipers = document.querySelectorAll('.service-item-slider .swiper');
  Array.prototype.forEach.call(navSwipers, function (swiper) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiper, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Scrollbar, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],
      slidesPerView: 1,
      autoplay: true,
      loop: true,
      speed: 400,
  ...
  var heroSwipers = document.querySelectorAll('.hero-slider .swiper');
  ...
  var imageWithTextSwipers = document.querySelectorAll('.image-with-text .swiper');
  ...
  var partnersSectionSwipers = document.querySelectorAll('.partners-section .swiper');
  ...
  var heroDeckingSwipers = document.querySelectorAll('.hero-decking .swiper');
  ...
  var woodSpeciesSwipers = document.querySelectorAll('.wood-species .swiper');
  ...
  var testimonialsSwipers = document.querySelectorAll('.testimonials-slider .swiper');
...
/******/ 	__webpack_require__.O(undefined, ["css/custom"], () => (__webpack_require__("./web/assets/babel/swipers.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/custom"], () => (__webpack_require__("./web/assets/sass/custom.scss")))
